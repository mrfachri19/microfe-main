...
export const searchArr = [
  {
    ...
    data: [
      ...
      },
      {
        ...
        icon: 'Circle',
        link: '/app/ecommerce/product-detail'
      },
      {
        id: 13,
        target: 'wishList',
