...
// ------------------------------------------------
mock.onGet('/app/calendar/events').reply(config => {
...
// POST: Add new event
// ------------------------------------------------
mock.onPost('/app/calendar/add-event').reply(config => {
...
// POST: Update Event
// ------------------------------------------------
mock.onPost('/app/calendar/update-event').reply(config => {
...
// DELETE: Remove Event
// ------------------------------------------------
mock.onDelete('/app/calendar/remove-event').reply(config => {
